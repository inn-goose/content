...
In this post, I summarize my observations of incorrect Arduino behavior made during debugging of the [EEPROM Programmer]((https://github.com/inn-goose/eeprom-programmer)) project. The related post, [EEPROM Programmer: Debugging Read Operations]((/blog/eeprom-programmer-3-debugging/)), describes the debugging process and the sequence of steps that led to identifying the root cause.
